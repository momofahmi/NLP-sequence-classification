...
This is the canonical mapping the team agreed on for the submission notebook. It includes every section so that anyone (incl. the marker) can run `main.ipynb` end-to-end and reproduce all the numbers in the report.
